...
/**
	@class
	@classdesc		Collections store.
	@alias			module:odin/dataSource.CollectionStore

	@desc			Collection store.
*/
...
/**
	...
	@param {String} p_name				Collectino name.
	@returns							The collection.
	@throws {module:odin.Exception}		If the collection doesn't exists.
*/
CollectionStore.prototype.get = function(p_name) {
...
*/
CollectionStore.prototype.add = function(p_collection) {
...
*/
CollectionStore.prototype.sync = function(p_driver) {
